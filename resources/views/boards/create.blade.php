...
@section('content')
    <div class="w-2/3 mx-auto">
        <form action="/board" method="post">
            ...
            <input id="title" class="border border-blue-200 w-full mt-16" type="text" name="title">
            <textarea id="story" class="border border-blue-200 w-full h-80 mt-8 resize-none" name="story"></textarea>
